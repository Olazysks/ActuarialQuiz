        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (question5ans1.isChecked() && question5ans2.isChecked() &&
                        question5ans4.isChecked() && question5ans5.isChecked() &&
                        question5ans6.isChecked() && question5ans7.isChecked()) {
                    score += 1;
                }
                ...
                // Starting new activity - ScoreActivity with passing over
                // int score and String username
                // as extra parameters
